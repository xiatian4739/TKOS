...
{
   // device寄存器: 0 1  2  3                             4        5          6            7
   //                    LBA地址23~27位                 DEV     1        MOD        1
   //                                                              DEV：主盘（0或从盘(1)       MOD:寻址模式  LBA:1,CHS:0
   uint8_t reg_device = BIT_DEV_MBS | BIT_DEV_LBA; /* device寄存器的一些关键位 */
                                                   /*BIT_DEV_MBS 0xa0 // 第7位和第5位固定为1  : 1010 0000
                                                   BIT_DEV_LBA 0x40        :  0100 0000
                                                   BIT_DEV_DEV 0x10    : 0001 0000
                                                
                                                                                     1010 0000
                                                                                    0100 0000
                                                                           ----------------------
                                                            reg_device =  1110 0000
                                                     */
